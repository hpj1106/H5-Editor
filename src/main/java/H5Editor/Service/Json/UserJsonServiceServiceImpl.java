...
@Service
public class UserJsonServiceServiceImpl implements UserJsonService {

    private UserRepository userRepository;

    private static final Logger LOGGER = LoggerFactory.getLogger(UserJsonServiceServiceImpl.class);

    @Autowired
    public UserJsonServiceServiceImpl(UserRepository userRepository) {
